...
function App() {
  const [widgets, setWidgets] = useState([
    { id: new Date().getTime(), component: <ClockWidget />, area: 'main-widget' },
    { id: new Date().getTime() + 2, component: <CalendarWidget />, area: 'right-widget' },
    { id: new Date().getTime() + 1, component: <TimerWidget />, area: 'left-widget' },
  ])
